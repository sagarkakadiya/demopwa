...
var AppComponent = /** @class */ (function () {
    function AppComponent(updates, data) {
        this.data = data;
        this.title = 'app';
        this.update = false;
    ...
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.data.gimmeJokes().subscribe(function (res) {
            _this.joke = res;
        });
    };
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_service_worker__WEBPACK_IMPORTED_MODULE_1__["SwUpdate"], _data_service__WEBPACK_IMPORTED_MODULE_2__["DataService"]])
    ], AppComponent);
    return AppComponent;
}());
...
module.exports = __webpack_require__(/*! C:\Users\Web Dev\Downloads\angular-6-pwa-master\src\main.ts */"./src/main.ts");
